// CS311 Yoshii - Struct Demo : how to store and how to display
// an array of structs
// ------------------------------------------------------
#include <iostream>
#include <string>
...
//Purpose: 
//  To fill the passed array with student data but using Default record
//  for unused slots. 
//Parameters: Slist array to hold student data, size is the array size
//Algorithm:
//  Uses a while loop that stops as soon as the user enters N or n
