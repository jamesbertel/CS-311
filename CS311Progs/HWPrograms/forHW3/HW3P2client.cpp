...
#include "slist.h"
#include <stdlib.h>
#ifndef HW3P2CLIENT_CPP
#define HW3P2CLIENT_CPP
...
{ 
  //1. L1 is empty and L2 is empty (true)
    slist L1, L2; cout << endl;
    if (L1 == L2) cout << "true" << endl; else cout << "false" << endl;
  
  //2. L1 is empty and L2 with 4, 5 (false)
    L2.addRear(4); L2.addRear(5); 
    if (L1 == L2) cout << "true" << endl; else cout << "false" << endl;

  //3.  The opposite (false)
    if (L2 == L1) cout << "true" << endl; else cout << "false" << endl;

  //4. L1 with 1,2,3 and L2 with  1,2,3 (true)
  ...
  //5. L1 with 1,2,3 and L2 with  1,2 (false)
    L2.deleteRear(x);
    if (L1 == L2) cout << "true" << endl; else cout << "false" << endl;
  ...
  //7. L1 has 1,2,3 and L2 has 1,2,4 (false)
    L2.deleteRear(x);
    L2.deleteRear(x);
    L2.addRear(4);
    if (L1 == L2) cout << "true" << endl; else cout << "false" << endl;
...
int main()
{
  ...
  cout << endl << "---- First Part testing done ----- \n" << endl;
