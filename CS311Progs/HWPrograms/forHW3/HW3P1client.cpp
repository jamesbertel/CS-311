...
void CopyTest(llist copiedList)
{
  ...
  llist copied(copiedList); //is there a better way to do this? probably
  copied.displayAll();
  cout << "finished" << endl;
}
...
{ 
  ...
  cout << "Step " << c << endl; c++;
  L.deleteIth(1, x); cout << "removed " << x << endl; //remove 4

  // 10. delete Ith I==6 (display the element removed) 5 6 7 8 9 
  cout << "Step " << c << endl; c++;
  L.deleteIth(6, x); cout << "removed " << x << endl; //remove 10

  // 11. delete Ith I==3 (display the element removed) 5 6 8 9
  cout << "Step " << c << endl; c++;
  L.deleteIth(3, x); cout << "removed " << x << endl;//remove 7
